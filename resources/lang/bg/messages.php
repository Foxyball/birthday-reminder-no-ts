...
return [
    ...
    // Dashboard
    'total_contacts' => 'Общо контакти',
    'upcoming_birthdays' => 'Предстоящи рождени дни',
    'recent_contacts' => 'Скорошни контакти',
    'created_at' => 'Добавено на',
    'no_contacts' => 'Няма намерени контакти',
];
