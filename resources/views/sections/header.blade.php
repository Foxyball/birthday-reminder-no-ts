    ...
    >
        ...
        >
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                <div class="relative">
                    <button class="hover:text-dark-900 flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white" id="langDropdownBtn">
                        <span class="ml-2 text-xs font-semibold">{{ strtoupper(app()->getLocale()) }}</span>
                    </button>
                    <div class="hidden absolute right-0 mt-2 w-32 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 dark:bg-gray-900 z-50" id="langDropdownMenu">
                        <a href="{{ route('lang.switch', 'bg') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 {{ app()->getLocale() == 'bg' ? 'font-bold' : '' }}">Български</a>
                        <a href="{{ route('lang.switch', 'en') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 {{ app()->getLocale() == 'en' ? 'font-bold' : '' }}">English</a>
                    </div>
                </div>
                <!-- Language Toggle Dropdown -->
