<section class="rounded-2xl border border-red-200 bg-red-50/70 p-6 dark:border-red-500/20 dark:bg-red-900/10">
    <header>
        <h2 class="text-lg font-medium text-red-700 dark:text-red-300">
            Delete Account
        </h2>

        <p class="mt-1 text-sm text-red-700/80 dark:text-red-200/80">
            This permanently deletes your account. Enter your current password to confirm.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.destroy') }}" class="mt-6 space-y-6">
        ...
        <div>
            <label for="password" class="mb-1.5 block text-sm font-medium text-red-700 dark:text-red-300">
                Current Password
            </label>
            <input
                id="password"
